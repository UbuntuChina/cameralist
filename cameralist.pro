...
UBUNTU_TRANSLATION_DOMAIN="cameralist.liu-xiao-guo"
...
aptest.commands = bash $$PWD/cameralist/tests/autopilot/run
aptest.depends  = sub-cameralist

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/cameralist/tests/unit
unittest.depends  = sub-cameralist
